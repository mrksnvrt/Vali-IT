...
import ee.bcs.valiit.dto.EmployeeData;
import ee.bcs.valiit.service.EmployeeService;
...
public class EmployeeController {
    ...
    public void addEmployee(@RequestBody EmployeeData employeeData) {
    ...
    public String showEmployee(@RequestBody EmployeeData employeeData) {
        String first_name = employeeData.getFirst_name();
        return employeeService.showEmployee(first_name);
    }
    //http://localhost:8080/mrksnvrt/showEmployee
    @DeleteMapping  ("mrksnvrt/deleteEmployee")
    public String deleteEmployee(@RequestBody EmployeeData employeeData) {
        String first_name = employeeData.getFirst_name();
        return employeeService.showEmployee(first_name);
    }
